...
function UserCard({ user, isConnection }) {
	return (
		<div className='bg-white w-full md:w-60 rounded-lg shadow-md shadow-offset-2 shadow-gray-500 p-4 flex flex-col items-center transition-all hover:shadow-md'>
